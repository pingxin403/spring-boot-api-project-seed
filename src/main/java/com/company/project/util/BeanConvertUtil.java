...
public class BeanConvertUtil {
    ...
    public static <T> T doConvert(Object source, Class<T> target) {
        ...
        try {
            ...
            throw new BusinessException(500, target + " - 可能为一个抽象类、接口、数组类、基本类型或者该类缺少无参构造方法！");
        } catch (IllegalAccessException e) {
            throw new BusinessException(500, target + " - 该类或其构造方法是不可访问的，或该类缺少无参构造方法！");
        } catch (FatalBeanException e) {
            throw new BusinessException(500, target + " - 序列化失败！");
        }
    }
