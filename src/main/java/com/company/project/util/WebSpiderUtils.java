...
import com.company.project.business.enums.CachePrefixEnum;
 ...
 * Include in com.hyp.learn.core.business.util
 * hyp create at 20-3-22
 **/
public class WebSpiderUtils {

    private static final String KEY = CachePrefixEnum.SPIDER.getMsg() + "list";
